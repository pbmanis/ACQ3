...
DFILE.AD_Range.v = [10 10 10];
DFILE.Amplifier_Gain.v = [0 0 0];
DFILE.Sensor_Range.v = [800 4000 400];
DFILE.Channels.v = [5 3 6]; % funny channels.....
DFILE.Low_Pass.v = [10 10 10];
DFILE.High_Pass.v = [0 0 0];
