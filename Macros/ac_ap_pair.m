function ac_ap_pair()
% ac_ap_pairm  -  protocol for "ltp" of a synaptic responses with spikes 
...
g ac_ltp_pair % conditioning stimuli are action potentials at time of epsp. superthreshold stimuli
take 120 % does 2/sec for 1 minute
if(check_macro_stop) return; end;
