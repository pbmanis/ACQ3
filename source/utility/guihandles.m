...
%   $Revision: 1.5 $  $Date: 2001/01/18 20:41:43 $
...
for this_h = all_h'
    ...
    if ~isempty(tag)  % can it be used as a fieldname?
        ...
        handles = setfield(handles, tag, [prev_h this_h]);
